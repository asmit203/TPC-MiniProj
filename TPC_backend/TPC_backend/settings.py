"""
Django settings for TPC_backend project.
...
# SECRET_KEY = "django-insecure-!!h^5)+5-c4=nr(!*$uvdzx*pda@#q9u+sc2#1u^!yunnk@2r_"
# SECRET_KEY = os.environ.get("SECRET_KEY")  # here
SECRET_KEY = env("SECRET_KEY")  # here
...
PASSWORD_HASHERS = (
    # 'tpc_backend.hashers.MyPBKDF2PasswordHasher',
